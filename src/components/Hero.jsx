...
const Hero = () => {
  return (
    <section className=" w-full h-screen mx-auto relative">
      <div className="absolute inset-0 top-36 flex gap-7 flex-row mx-auto items-start sm:px-16 px-6">
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            ...
            <br className="sm:block hidden" />  and I am particularly interested in   <br className="sm:block hidden" /> front-end
            development. <br className="sm:block hidden" /> I love creating
            user-friendly designs <br className="sm:block hidden" /> and keeping
            up with the latest trends <br className="sm:block hidden" /> in
            technology.
          </p>
        </div>
      </div>
